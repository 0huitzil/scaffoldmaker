...
body_terms = [
    ...
    ("left antebrachium", ""),
    ("left hand", ""),
    ("left hand skin epidermis outer surface", ""),
    ...
    ("right antebrachium", ""),
    ("right hand", ""),
    ("right hand skin epidermis outer surface", ""),
