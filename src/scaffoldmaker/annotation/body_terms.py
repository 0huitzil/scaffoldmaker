...
body_terms = [
    ...
    ("right hand", "ILX:"),
    ("left hand", "ILX:"),
    ("right hand skin epidermis outer surface", "ILX:"),
    ("left hand skin epidermis outer surface", "ILX:"),
    ("left", ""),
    ...
    ("right foot", "ILX:"),
    ("left foot", "ILX:"),
    ("right foot skin epidermis outer surface", "ILX:"),
    ("left foot skin epidermis outer surface", "ILX:"),
